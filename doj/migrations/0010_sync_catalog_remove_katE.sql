...
§9 Abs. 1a | Handel mit Betäubungsmitteln | $1.000 | 15 - 20 | zzgl. $250 Aufschlag pro Drogeneinheit
§9 Abs. 1b | Wer für Betäubungsmittel wirbt | $800 | -
§9 Abs. 1c | Falsche Angaben um an eine Verschreibung für Btm zu kommen | $1.200 | -
§9 Abs. 1d | Besitz von Btm über dem Eigenbedarf | $900 | -
[StVO] Straßenverkehrsordnung
...
UPDATE laws
SET
  html = REPLACE(REPLACE(REPLACE(REPLACE(html,
    'Kategorien B, C, D oder E aufgeführt', 'Kategorien B, C, D aufgeführt'),
    'Kategorien C, D oder E aufgeführt',    'Kategorien C, D aufgeführt'),
    'Kategorien B, D oder E aufgeführt',    'Kategorien B, D aufgeführt'),
    'Kategorien B, C oder E aufgeführt',    'Kategorien B, C aufgeführt'),
